    ...
    <div class="flex h-screen">
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 p-4 space-y-1">
                    ...
                    <a href="{{ route('admin.project-types.index') }}" 
                       class="nav-item {{ request()->routeIs('admin.project-types.*') ? 'active' : '' }}">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-4 border-t border-slate-200">
                    <div class="flex items-center gap-3">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="action-button" title="Logout">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <aside class="fixed left-0 top-0 h-full w-64 bg-white flex flex-col">
                ...
                <div class="flex-1 overflow-y-auto">
                    <nav class="p-4 space-y-1">
                        ...
                        <a href="{{ route('admin.project-types.index') }}" class="nav-item {{ request()->routeIs('admin.project-types.*') ? 'active' : '' }}">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                            </svg>
                            Categories
        ...
        <main class="admin-main flex-1">
            ...
            <header class="admin-header">
                <div class="flex items-center justify-between h-16 px-6">
                    <div class="flex items-center gap-4">
                        ...
                        <h1 class="text-xl font-semibold">{{ $pageTitle ?? 'Dashboard' }}</h1>
                    </div>

                    <div class="flex items-center gap-4">
                        <a href="{{ route('home') }}" target="_blank" class="action-button" title="Visit site">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="admin-content">
                <!-- Flash Messages -->
                @if(session('success'))
                <div class="alert bg-green-50 border-green-200 text-green-800 animate-slide-in">
                ...
                @if(session('error'))
                <div class="alert alert-destructive animate-slide-in">
                    <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
